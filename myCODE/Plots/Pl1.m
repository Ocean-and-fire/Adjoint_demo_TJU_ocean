...
hold on 
plot(x,TB3,'g-','LineWidth',2)
hold on 
plot(x,TB4,'m-','LineWidth',2)
hold on 
plot(x,TB2,'r-','LineWidth',2)
hold on 
ylim([-1,1])
legend('真实','噪声：0.08','噪声：0.1','噪声：0.5','噪声：0.8');
...
hold on 
set(gca, 'xtick', 1:1:4);
set(gca,'xticklabel',{'0.08','0.1','0.5','0.8'},'FontSize',15);
xlabel('噪声');ylabel('RMSE');
set(gca,'Fontsize',14,'FontWeight','bold')
subplot(2,4,[5,7])
x = 1:length(XB);
...
hold on 
plot(x,XB3,'g-','LineWidth',2)
hold on 
plot(x,XB4,'m-','LineWidth',2)
hold on 
plot(x,XB2,'r-','LineWidth',2)
hold on 
ylim([-1,1])
legend('真实','噪声：0.08','噪声：0.1','噪声：0.5','噪声：0.8');
