...
if (display)
  fprintf(' iter        f(x)          MAE             RMSE\n')
  fprintf('-----------------------------------------------\n')
  [opt1,opt2] = get_optimality(x,g,l,u);
  fprintf('%3d %16.8f %16.8f %16.8f\n',k,f,opt1,opt2);
end
...
function [opt1,opt2] = get_optimality(x,g,l,u)
